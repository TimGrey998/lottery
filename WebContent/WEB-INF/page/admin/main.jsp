...
<head>
    ...
    <meta name="viewport" content="width=device-wi	dth, initial-scale=1, maximum-scale=1">
    ...
    <link rel="stylesheet" href="/lottery/layui/css/themes/default.css" media="all">
    <link rel="stylesheet" href="/lottery/layui/css/public.css" media="all">
    <!--[if lt IE 9]>
...
<script src="/lottery/layui/lib/layui-v2.5.5/layui.js" charset="utf-8"></script>
<script src="/lottery/layui/js/lay-config.js?v=2.0.0" charset="utf-8"></script>
<script>
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        ...
        var options = {
            iniUrl: "/lottery/layui/api/init.json",    // 初始化接口
            clearUrl: "/lottery/layui/api/clear.json", // 缓存清理接口
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '/lottery/layui/page/login-3.html';
            });
        });
    });
</script>

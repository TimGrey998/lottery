...
INSERT INTO `player` VALUES (1,'gyf'),(2,'kcs'),(3,'a'),(4,'123');
...
CREATE TABLE `prize` (
  ...
  PRIMARY KEY (`prizeId`),
  UNIQUE KEY `prizeId_UNIQUE` (`prizeId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `prize` VALUES (1,'kindle1123',1,'f1d4a4c2-b7ea-48fd-8471-e812f4154236.jpg','aaaaa1222');
...
-- Dump completed on 2020-12-24 10:44:53
